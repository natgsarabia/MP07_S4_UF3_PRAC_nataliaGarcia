  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                <form id="users-form" method="POST" action="{{ route('usuaris.update', $usuari->id) }}">
                    @csrf
                    @method('PUT')
                    <td><input type="text" style="border:0px" name="nom" value="{{ $usuari->nom }}"></td>
                    <td><input type="text" style="border:0px" name="email"  value="{{ $usuari->email }}"></td>
                    <td><input type="text" style="border:0px" name="edat"  value="{{ $usuari->edat }}"></td>
                    <td>
