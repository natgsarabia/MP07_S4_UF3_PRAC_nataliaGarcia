...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <div class="containerForm">
        <form method="POST" class="RegisterUsuari" name="createNew" action="<?php echo e(url('/usuaris')); ?>">
            <?php echo csrf_field(); ?>
            <div>
                <p>Nom: <input class="register-input" type="text" name="nom" required></p>
                <p>Email: <input class="register-input" type="email" name="email" required></p>
                <p>Edat: <input class="register-input" type="number" name="edat" required></p>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\M7-DESENVOLUPAMENT_WEB_DENTORN_SERVIDOR\MP07_S4_UF3_PRAC_nataliaGarcia\exercici2\resources\views/create.blade.php ENDPATH**/ ?>