    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form method="POST" action="<?php echo e(url('/usuaris')); ?>">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
                        <input type="hidden" name="id" value="<?php echo e($usuari->id); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\M7-DESENVOLUPAMENT_WEB_DENTORN_SERVIDOR\MP07_S4_UF3_PRAC_nataliaGarcia\exercici2\resources\views/delete.blade.php ENDPATH**/ ?>